...
#initializefunction
	...
	def draw_frame1(self):
		...
		self.browse_button=Tkinter.Button(self.f1,text=u"Browse!") #command=self.onBrowse1
	...
	def draw_frame2(self):
		...
		self.browse2_button=Tkinter.Button(self.f2,text=u"Browse!")#,command=self.OnBrowse2
